...
try:
    ...
    if PLATFORM == 'linux2':
        try:
            ...
            print("\nMESSAGE: All depedencies were installed successfuly, enjoy using vM cleaner \n ")
            sys.exit()
        except:
            raise
    else:
...
def Addition_ESXES():
    ...
    while ESX_1 == " " or (not ESX_1):
        ...
        ESX_1 = input("Provide IP of the 1-st ESX -> ")
    else:
        pass

    '''#### Setting ip address for other ESX'es'''
    ESX_2 = input("Provide IP of the 2-nd ESX -> ")
    ...
    if ESX_2 != 0:
        ESX_3 = input("Provide IP of the 3-rd ESX -> ")
    ...
    if ESX_3 != 0:
        ESX_4 = input("Provide IP of the 4-th ESX -> ")
    ...
    if ESX_4 != 0:
        ESX_5 = input("Provide IP of the 5-th ESX -> ")
    ...
    if ESX_5 != 0:
        ESX_6 = input("Provide IP of the 6-th ESX -> ")
    ...
    if ESX_6 != 0:
        ESX_7 = input("Provide IP of the 7-th ESX -> ")
    ...
    if ESX_7 != 0:
        ESX_8 = input("Provide IP of the 8-th ESX -> ")
...
while [1]:
    ...
    if main_menu == 0:
        ...
        print("Warning: Before romoving, please UNREGISTER plugin from VC via powerCLI and close SSH connection to your vCenter")
